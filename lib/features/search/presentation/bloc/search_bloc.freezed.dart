...
// ignore: unused_element
  _SearchStateLoaded loaded({@required List<PasswordEntity> passwords}) {
...
mixin _$SearchState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult loaded(List<PasswordEntity> passwords),
  ...
  TResult maybeWhen<TResult extends Object>({
    TResult initial(),
    TResult loading(),
    TResult loaded(List<PasswordEntity> passwords),
...
abstract class _$SearchStateLoadedCopyWith<$Res> {
  ...
  $Res call({List<PasswordEntity> passwords});
}
  ...
  $Res call({
    ...
    return _then(_SearchStateLoaded(
      passwords: passwords == freezed
          ? _value.passwords
          : passwords as List<PasswordEntity>,
    ));
  }
}
...
class _$_SearchStateLoaded implements _SearchStateLoaded {
  const _$_SearchStateLoaded({@required this.passwords})
  ...
  @override
  String toString() {
    return 'SearchState.loaded(passwords: $passwords)';
  }
        ...
        (other is _SearchStateLoaded &&
            (identical(other.passwords, passwords) ||
                const DeepCollectionEquality()
                    .equals(other.passwords, passwords)));
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(passwords);
...
abstract class _SearchStateLoaded implements SearchState {
  const factory _SearchStateLoaded({@required List<PasswordEntity> passwords}) =
      _$_SearchStateLoaded;

  List<PasswordEntity> get passwords;
  @JsonKey(ignore: true)
  _$SearchStateLoadedCopyWith<_SearchStateLoaded> get copyWith;
}
